IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'inaproc_paket_anggaran_swakelola')
BEGIN
    CREATE TABLE inaproc_paket_anggaran_swakelola (
    ...
    CREATE INDEX idx_ipas_kd_klpd_tahun ON inaproc_paket_anggaran_swakelola(kd_klpd, tahun_anggaran);
    CREATE INDEX idx_ipas_kd_satker ON inaproc_paket_anggaran_swakelola(kd_satker);
    CREATE INDEX idx_ipas_kd_rup ON inaproc_paket_anggaran_swakelola(kd_rup);
END;